node(env.SLAVE) {
    ...
    stage('Packaging and Publishing results') {
        ...
        /*d)*/ sh 'curl -v -u admin:admin123 --upload-file pipeline-'+student+'-${BUILD_NUMBER}.tar.gz http://10.6.102.46:8081/repository/artifacts/task11Gid/task11Aid/pipeline-'+student+'-${BUILD_NUMBER}.tar.gz'
