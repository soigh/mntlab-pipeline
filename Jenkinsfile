node(env.SLAVE) {
    ...
    stage('Packaging and Publishing results') {
        ...
        /*d)*/ sh 'curl -v -u admin:admin123 --upload-file pipeline-'+student+'-${BUILD_NUMBER}.tar.gz http://192.168.56.51:8081/repository/artifacts/pipeline-'+student+'-${BUILD_NUMBER}.tar.gz'
