node (env.SLAVE) {
    ...
    stage ('Packaging and Publishing results') {
        ...
        /*d)*/ nexusArtifactUploader artifacts: [[artifactId: 'task11ArtifactId', classifier: '', file: 'pipeline-'+env.student+'-${BUILD_NUMBER}.tar.gz' , type: 'tar.gz']], credentialsId: 'nexus_cred', groupId: 'task11GroupId', nexusUrl: '10.6.102.46:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'artifacts', version: '1.0'
    }
